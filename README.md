...
|----------|----------|------|-----|
| worker-00 | HP ProDesk Mini G4 | k3s server only (control-plane taint, no workloads) | 192.168.30.129 |
| worker-01 | HP ProDesk Mini G9 — i5 12th gen, 16GB RAM, 12TB USB | k3s agent, NFS server, all media workloads | 192.168.30.194 |
